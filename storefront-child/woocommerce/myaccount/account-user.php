<div class="account-user circle" style="float: right; text-align: center">
	...
	<?php 
	 ...
	 ?>
	<img src="<?php echo get_user_meta( $user_id,'avatar',true ) ? get_user_meta( $user_id,'avatar',true ) : get_avatar_url($user_id);?>" id="user_avatar" style="display: block; margin:0 auto; width: 70px; height: 70px; object-fit: cover; border-radius: 50%" onclick="window.location.href='<?php echo esc_html( home_url('/')).'profile' ?>'"/>
		</span>
