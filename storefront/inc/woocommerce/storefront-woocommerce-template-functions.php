...
if ( ! function_exists( 'storefront_handheld_footer_bar_transfer' ) ) {
	...
	function storefront_handheld_footer_bar_transfer() {
		echo '<a href="' . home_url() . '/transfer">' . esc_attr__( 'Flaticon Transfer', 'storefront' ) . '</a>';
	}
}
...
if ( ! function_exists( 'storefront_handheld_footer_bar_account_link' ) ) {
	...
	function storefront_handheld_footer_bar_account_link() {
		echo '<a href="' . esc_url( get_permalink( get_option( 'woocommerce_myaccount_page_id' ) ) ) . '">' . esc_attr__( 'Account', 'storefront' ) . '</a>';
	}
}
